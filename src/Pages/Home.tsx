  ...
  return (
    <>
      ...
      <section className="py-12 px-6 lg:px-16 bg-white">
        <div className=" mx-auto rounded-3xl overflow-hidden grid grid-cols-1 md:grid-cols-12 bg-gradient-to-r from-red-950 via-[#4A1E27] to-red-950 shadow-xl border border-red-900/10">
